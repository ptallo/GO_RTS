...
type Game struct {
	...
	imageLibrary *render.ImageLibrary
	gameMap      *GameMap
	unit         *Unit
}
...
func (g *Game) Draw(screen *ebiten.Image) {
	g.gameMap.DrawMap(g.camera, screen, g.imageLibrary)
	g.unit.DrawUnit(g.camera, screen, g.imageLibrary)
}
